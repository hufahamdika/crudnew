                ...
                {{-- <div class="row page-bg"> --}}
                    <div class="p-4">
                        <div class="text-center top-icon">
                            <center><h3>Edit Rekam Medis</h3></center>
                            <br>
                            ...
                            <form id="form-edit" action="{{ route('record.update', $data->id) }}" method="post">
                                ...
                                {{-- <div class="mt-3 mb-3 form-floating">
                                    ...
                                    placeholder="Joko Amanto" value="{{ $data->patient->name }}">
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    ...
                                    placeholder="42" value="{{ $data->patient->age }}">
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    ...
                                    placeholder="Pria" value="{{ $data->patient->gender }}">
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    ...
                                    placeholder="37.1" step="any"  value="{{ $data->temperature }}">
                                ...
                                <div class="mt-3 mb-3 form-floating">
                                    ...
                                    placeholder="So Goood"  value="{{ $data->condition }}">
                            ...
                            <div class="mt-4 text-center submit-btn">
                                ...
                                <button type="submit" class="btn btn-primary" form="form-edit">Edit Data</button>
                            </div>
